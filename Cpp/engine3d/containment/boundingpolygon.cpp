...
#include "boundingpolygon.h" // class's header file
...
BoundingPolygon::BoundingPolygon(Vector vertices[], int number)
{
	for (int i = 0; i < number; i++) {
        ...
        mTransformedVertices.Add(vertices[i]);
    }
}
...
BoundingPolygon* BoundingPolygon::Clone() const 
{
	...
	for (int i = 0; i < mVertices.Size(); i++) {
        ...
        p_bound->mVertices.Add(mVertices[i]);
        p_bound->mTransformedVertices.Add(mTransformedVertices[i]);
    }
    return p_bound;
}
...
void BoundingPolygon::AddVertex(const Vector& rVertex) {
    mVertices.Add(rVertex);
    mTransformedVertices.Add(rVertex);
